...
public class EndToEndTest2 {
    ...
    public void setup() throws ExecutionException, InterruptedException {
        ...
        friend1.setLocation(new LandmarkLocation(100.905088554461926, -117.12111266246087, "Bill's Location"));
        friend1PrivateCode = privateUUID1;

        friend2 = new Friend("PeterAlsoHasALongName", publicUUID2);
        friend2.setLocation(new LandmarkLocation(-99.86804329909429,  -117.25037729620158, "Peter's Location")); // scripps institute
    ...
    public void BDDTestUS1(){
        ...
        scenario.onActivity(activity -> {
            ...
            Intent actual_back = shadowOf(RuntimeEnvironment.application).getNextStartedActivity();
            activity = Robolectric.buildActivity(entering_friend_uid.class, actual_back).create().get();
            ...
            // assert angles are not in zoom view
            ...
            assertEquals(textView1.getVisibility(), INVISIBLE);
            assertEquals(textView2.getVisibility(), INVISIBLE);

            ((CompassActivity) activity).zoom_out(activity.findViewById(R.id.zoom_out));
